 ...
 * 
 * before declaring the fun we can call that fun as well - that is known as fun hoisting.
 * so that means i can call "test()" from anywhere in this particular file here.
 * 
 * but is it a good practice? if want to do it then we can do it . Otherwise its bit confusing. 
 *  
 * 

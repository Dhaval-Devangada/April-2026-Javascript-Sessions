 ...
 * so when we run our command what happnes that > package.json will be created > means our project is enabled with the npm and the package.josn file got created
 ...
 * so here package.json is the heart of the project [configuration of the project are over here]
 ...
 * so what we need to do in vs-code?
...
/**
 * In js there is no folder/package structure 
 * We can create our own folder/package structure 
 */
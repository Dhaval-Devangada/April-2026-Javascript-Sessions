 ...
 * 
 * first let's discuss how we will call these kind of function
...
//so if you are having function expression name / reference name for that particular function, then everywhere you will use the "reference name" and not the actual function name/big function name
 ...
 * so why don't we give sort name here / or some expression / some meaningfull name 
...
//we might use the function expression because, exactly same thing we can do with the normal function
...
//once we create the "ref name/function expression/var name" then no one can use the original function name / long function name, its a drawback here
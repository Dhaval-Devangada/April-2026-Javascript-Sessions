 ...
 * Hoisting means you are trying to any variable before it's declaration
 */
...
//so that isa another problem with the var variable, that in the legasy code you are using var and you are trying to access before it's declaration then it will give you undefine
...
//hoisting is not allowed with let and it will give you > error
//hoisting is not allowed with const and it will give you > error
